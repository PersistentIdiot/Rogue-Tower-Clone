...
public class GimbalController : MonoBehaviour
{
    ...
    public Transform HorizontalPivot { get { return horizontalPivot; } set { horizontalPivot = value; } }

    [SerializeField]
    protected Transform verticalPivot;
    public Transform VerticalPivot { get { return verticalPivot; } set { verticalPivot = value; } }

    [SerializeField]
    protected Transform gimbalChild;
    public Transform GimbalChild { get { return gimbalChild; } }
    ...
    public bool NoConstraintsHorizontal { get { return noConstraintsHorizontal; } set { noConstraintsHorizontal = value; } }

    // The horizontal arc angle
    [SerializeField]
    protected float minHorizontalPivotAngle = -180;
    public float MinHorizontalPivotAngle { get { return minHorizontalPivotAngle; } set { minHorizontalPivotAngle = value; } }

    [SerializeField]
    protected float maxHorizontalPivotAngle = 180;
    public float MaxHorizontalPivotAngle { get { return maxHorizontalPivotAngle; } set { maxHorizontalPivotAngle = value; } }
    ...
    public float MinVerticalPivotAngle { get { return minVerticalPivotAngle; } set { minVerticalPivotAngle = value; } }

    // The maximum angle for the vertical pivot
    [SerializeField]
    protected float maxVerticalPivotAngle = 90f;
    public float MaxVerticalPivotAngle { get { return maxVerticalPivotAngle; } set { maxVerticalPivotAngle = value; } }
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        float arcRadius = (gimbalChild == null || verticalPivot == null) ? 30 : (gimbalChild.transform.position - verticalPivot.transform.position).magnitude;
        ...
        if (verticalPivot != null)
        {
            ...
            UnityEditor.Handles.DrawSolidArc(verticalPivot.position, rightVec, startVec, maxVerticalPivotAngle - minVerticalPivotAngle, arcRadius);
        }
        ...
        if (horizontalPivot != null)
        {
            ...
            UnityEditor.Handles.DrawSolidArc(
                verticalPivot != null ? verticalPivot.position : horizontalPivot.position,
                horizontalPivot.up,
                startVecH,
                maxHorizontalPivotAngle - minHorizontalPivotAngle,
                arcRadius
            );
        }
        ...
        Gizmos.DrawLine(pos, pos + idleVec * (arcRadius * 1.25f));
